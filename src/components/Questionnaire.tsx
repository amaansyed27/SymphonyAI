...
const Questionnaire: React.FC<QuestionnaireProps> = ({ onComplete }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-slate-800/60 backdrop-blur-lg rounded-2xl p-8 border border-slate-700/50">
        ...
        {currentQuestion.options ? (
              ...
              <button
                ...
                className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 ${
                  currentAnswer === option.value
                    ...
                    : 'border-slate-600 bg-slate-700/30 text-blue-100 hover:border-blue-300 hover:bg-slate-600/50'
                }`}
              >
          ...
          <div>
            <textarea
              ...
              className="w-full p-4 rounded-xl bg-slate-700/50 border border-slate-600 text-white placeholder-blue-200 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 resize-none"
              rows={4}
            />
          </div>
        )}
      ...
      <div className="mt-6 bg-slate-800/30 backdrop-blur-lg rounded-xl p-4 border border-slate-700/50">
